...
from .views import SignInView, SignOutView, registration_step1, registration_step2, \
    ...
    DoctorProfileDetails, DoctorProfileEdit, UserProfilePictureChange, PatientHistoryAppointment, delete_appointment
...
urlpatterns = [
    ...
    path('patient/<int:pk>/appointments/history/', PatientHistoryAppointment.as_view(),
         name='patient history appointments'),
